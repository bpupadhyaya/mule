...
public class UntilSuccessfulTestCase extends FunctionalTestCase
{
    ...
    public void testDefaultConfiguration() throws Exception
    {
        ...
        runFlowAsync("minimal-config", payload);
    ...
    {
        final String payload = RandomStringUtils.randomAlphanumeric(20);
        final MuleMessage response = runFlow("full-config-with-mp", payload).getMessage();
    ...
    {
        final String payload = RandomStringUtils.randomAlphanumeric(20);
        runFlowAsync("retry-endpoint-config", payload);
