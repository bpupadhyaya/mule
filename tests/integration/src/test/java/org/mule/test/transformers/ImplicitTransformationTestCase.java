...
public class ImplicitTransformationTestCase extends FunctionalTestCase
{
    ...
    public void testImplicitInputStreamToStringConversion() throws Exception
    {
        ...
        MuleMessage response = runFlow("StringEchoService", inputStream).getMessage();
    ...
    {
        MuleMessage response = runFlow("StringEchoService", "TEST".getBytes()).getMessage();
        assertThat(response.getPayload(), is("TSET"));
    }
    ...
    {
        InputStream inputStream = new StringInputStream("TEST");
        MuleMessage response = runFlow("ByteArrayEchoService", inputStream).getMessage();
        assertThat(response.getPayload(), is("TSET"));
    }
    ...
    {
        MuleMessage response = runFlow("ByteArrayEchoService", "TEST").getMessage();
        assertThat(response.getPayload(), is("TSET"));
    }
    ...
    {
        MuleMessage response = runFlow("InputStreamEchoService", "TEST").getMessage();
        assertThat(response.getPayload(), is("TSET"));
    }
    ...
    {
        MuleMessage response = runFlow("InputStreamEchoService", "TEST".getBytes()).getMessage();
        assertThat(response.getPayload(), is("TSET"));
    }
