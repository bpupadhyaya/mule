...
public class SharedInterceptorStackTestCase extends FunctionalTestCase
{
    ...
    {
        MuleMessage response = runFlow("serviceOne", getTestMuleMessage(TEST_MESSAGE)).getMessage();
    ...
    {
        MuleMessage response = runFlow("serviceTwo", getTestMuleMessage(TEST_MESSAGE)).getMessage();
