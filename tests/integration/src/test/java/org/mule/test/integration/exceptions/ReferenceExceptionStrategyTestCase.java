...
public class ReferenceExceptionStrategyTestCase extends FunctionalTestCase
{
    ...
    {
        MuleMessage response = runFlow("referenceExceptionStrategyFlow", getTestMuleMessage(JSON_REQUEST)).getMessage();
    ...
    public void testFlowUsingConfiguredExceptionStrategy() throws Exception
    {
        try
        {
            runFlow("configuredExceptionStrategyFlow", getTestMuleMessage(JSON_REQUEST)).getMessage();
