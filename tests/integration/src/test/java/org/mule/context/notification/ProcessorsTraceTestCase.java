...
public class ProcessorsTraceTestCase extends FunctionalTestCase
{
    ...
    {
        runFlow("flowStatic", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowStatic", TEST_PAYLOAD);
    ...
    {
        runFlow("flowDynamic", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowDynamic", TEST_PAYLOAD);
    ...
    {
        runFlow("secondFlowStatic", TEST_PAYLOAD);
    ...
    {
        runFlow("secondSubFlowStatic", TEST_PAYLOAD);
    ...
    {
        runFlow("secondFlowDynamic", TEST_PAYLOAD);
    ...
    {
        runFlow("secondSubFlowDynamic", TEST_PAYLOAD);
    ...
    {
        runFlow("flowStaticWithAsync", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowStaticWithAsync", TEST_PAYLOAD);
    ...
    {
        runFlow("flowDynamicWithAsync", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowDynamicWithAsync", TEST_PAYLOAD);
    ...
    {
        runFlow("flowStaticWithEnricher", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowStaticWithEnricher", TEST_PAYLOAD);
    ...
    {
        runFlow("flowDynamicWithEnricher", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowDynamicWithEnricher", TEST_PAYLOAD);
    ...
    {
        runFlow("flowStaticWithChoice", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowStaticWithChoice", TEST_PAYLOAD);
    ...
    {
        runFlow("flowDynamicWithChoice", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowDynamicWithChoice", TEST_PAYLOAD);
    ...
    {
        runFlow("flowStaticWithScatterGather", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowStaticWithScatterGather", TEST_PAYLOAD);
    ...
    {
        runFlow("flowDynamicWithScatterGather", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowDynamicWithScatterGather", TEST_PAYLOAD);
    ...
    {
        runFlow("flowStaticWithScatterGatherChain", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowStaticWithScatterGatherChain", TEST_PAYLOAD);
    ...
    {
        runFlow("flowDynamicWithScatterGatherChain", TEST_PAYLOAD);
    ...
    {
        runFlow("subFlowDynamicWithScatterGatherChain", TEST_PAYLOAD);
